...
async def stop(_, message: Message):
    ...
    if chat_id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("❌ Tidak ada lagu yg sedang di stream")
    else:
        try:
        ...
        await message.reply_text("⏹ Istirahat dulu")
...
async def skip(_, message: Message):
    ...
    chat_id = chid
    if chat_id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("❌ Tidak ada antrian selanjutnya")
    else:
